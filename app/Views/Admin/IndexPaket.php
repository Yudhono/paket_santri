                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class="fa fa-table"></i>Data Paket<br><small></small>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <a href="<?php echo base_url('paket/create'); ?>" type="button" class="btn btn-primary">Tambah data</a>
                            </div>
                        </div>
                        <!-- Datatables Content -->
                                        ...
                                        foreach ($paket as $key => $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="<?php echo base_url('paket/edit/' . $data['id_paket']); ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                                        <a href="<?php echo base_url('paket/delete/' . $data['id_paket']); ?>" class="btn btn-xs btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data <?php echo $data['nama_paket']; ?>')"><i class="fa fa-times"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
