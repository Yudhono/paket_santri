                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="block">
                                    ...
                                    <form action="<?php echo base_url('paket/store'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Nama Paket</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-text-input" name="nama_paket" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-email-input">Tanggal Diterima</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-text-input" name="tanggal_diterima" class="form-control" placeholder="yyyy-mm-dd">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="example-text-input" name="pengirim_paket" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-textarea-input">Isi Paket yg Disita</label>
                                            <div class="col-md-9">
                                                <textarea id="example-textarea-input" name="isi_paket_yg_disita" rows="9" class="form-control" placeholder=""></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
