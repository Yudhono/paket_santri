                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class="gi gi-notes_2"></i>Edit Data Santri<br><small></small>
                                </h1>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        <h2><strong>Edit Data Santri</h2>
                                    </div>
                                    <!-- END Form Elements Title -->

                                    <!-- Basic Form Elements Content -->
                                    <form action="<?php echo base_url('santri/update/' . $santri['NIS']); ?>); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">NIS</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-text-input" name="NIS" value="<?php echo $santri['NIS']; ?>" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-email-input">Nama Santri</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-text-input" name="nama_santri" value="<?php echo $santri['nama_santri']; ?>" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-email-input">Alamat</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-text-input" name="alamat" value="<?php echo $santri['alamat']; ?>" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select id="example-select" name="id_asrama" class="form-control" size="1">
                                                    <option value="<?php echo $santri['id_asrama']; ?>"><?php echo $santri['nama_asrama']; ?></option>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="example-text-input" name="total_paket_diterima" value="<?php echo $santri['total_paket_diterima']; ?>" class="form-control" placeholder="">
                                            </div>
                                        </div>
