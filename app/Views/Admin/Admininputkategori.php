                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class="gi gi-notes_2"></i>Tambah Data Kategori<br><small></small>
                                </h1>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        <h2><strong>Input Data Kategori Paket</h2>
                                    </div>
                                    <!-- END Form Elements Title -->

                                    <!-- Basic Form Elements Content -->
                                    <form action="<?php echo base_url('kategori/store'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Nama Kategori</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-text-input" name="nama_kategori" class="form-control" placeholder="">
                                            </div>
                                        </div>
