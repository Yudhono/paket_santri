                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class="fa fa-table"></i>Data Asrama<br><small></small>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <a href="<?php echo base_url('asrama/create'); ?>" type="button" class="btn btn-primary">Tambah data</a>
                            </div>
                        </div>
                        <!-- Datatables Content -->
                        <div class="block full">
                            <div class="block-title">
                                <h2><strong>List Data Asrama</h2>
                            </div>
                                        ...
                                        foreach ($asrama as $key => $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="<?php echo base_url('asrama/edit/' . $data['id_asrama']); ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                                        <a href="<?php echo base_url('asrama/delete/' . $data['id_asrama']); ?>" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data <?php echo $data['nama_asrama']; ?> ini?')"><i class="fa fa-times"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
